  ...
  return (
    <div className="text-center">
      ...
      <main className="main">
        ...
        <div className='pt-5'>
          <h2 className='uppercase font-bold text-lg'>About Us</h2>
        ...
        <div>
          <h2 className='uppercase font-bold pt-5 text-lg'>Where you can find us</h2>
        ...
        <div className='pt-5'>
          <h2 className='uppercase font-bold text-lg'>What we're doing</h2>
